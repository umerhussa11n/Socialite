...
//echo '====<br/>last posted post id : '.$last_posted_post_id.'====<br/>'; 
...
//                            }
				...
				$tmp['link_url'] = $v->link_url;
                                ...
                                $tmp['post_to'] = $fv->social_media_flag;
                                 ...
                                 if(!isset($list[$tmp['post_to']."_".$tmp['post_to_page']]))
                                 {
                                    $test_key = $tmp['post_to']."_".$tmp['post_to_page'];
                                    $list[$test_key] = $tmp;
                                 }
			}
